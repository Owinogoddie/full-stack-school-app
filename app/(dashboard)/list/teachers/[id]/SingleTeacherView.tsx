// app/list/teachers/[id]/SingleTeacherView.tsx
'use client';
...
const SingleTeacherView: React.FC<SingleTeacherViewProps> = ({ teacher }) => {
              ...
              <div className="w-2/3 flex flex-col justify-between gap-4">
                ...
                <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
                  <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                    ...
                    <span>
                      {new Intl.DateTimeFormat("en-GB").format(teacher.dateOfBirth)}
                    </span>
                  </div>
                  <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
...
export default SingleTeacherView;